	...
	<div class="flex flex-col-reverse md:flex-col items-center md:items-start justify-center">
		<div>
			...
			<div class="form-control relative w-full">
				...
				<button
					class="absolute top-0 ltr:rounded-l-none rtl:rounded-r-none btn btn-primary ltr:right-0 rtl:left-0"
				>
					<svg
						class="w-8 h-6 fill-base-100 rtl:rotate-180"
		...
		<div class="w-full flex justify-center md:justify-start">
			<svg
				...
				version="1.0"
				viewBox="0 0 309.9 98"
				><defs><clipPath id="a"><path d="M37.5 148.4h300v78h-300zm0 0" /></clipPath></defs><g
					clip-path="url(#a)"
					transform="translate(-32.5 -138.4)"
					><path
						fill="#ffff00"
