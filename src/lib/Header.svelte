...
<main class="rounded-lg shadow bg-base-200 drawer h-52">
	<input id="main-drawer" type="checkbox" class="drawer-toggle" />
	<div class="flex flex-col drawer-content">
		<div class="flex items-center sm:justify-evenly lg:justify-around mb-2 shadow-lg bg-base-100 text-base-content">
			...
			<div class="w-1/3 pr-2 flex justify-end">
				...
				<button class="hidden md:inline-block btn btn-square btn-ghost" on:click={switchDirection}>
					<!-- Language switcher -->
	...
	<div class="drawer-side">
		...
		<ul class="p-4 overflow-y-auto menu w-80 bg-base-100">
			<li><a href="/" class="navbar-category">Home</a></li>
			<li><a href="/category/men" class="navbar-category">Men</a></li>
			<li><a href="/category/women" class="navbar-category">Women</a></li>
			<li><a href="/category/accessories" class="navbar-category">Accessories</a></li>
			<li><a href="/category/outlet" class="navbar-category">Outlet</a></li>
		</ul>
	</div>
</main>
